...
//    throw new UnsupportedOperationException("implement this");
    ...
    public Iterator<Tuple> iterator() {
        ArrayList<Tuple> tupleArr = new ArrayList<Tuple>();
        for(int i = 0; i< tuples.length; i++){
        	//Before adding the tuple, I should check if the slot is not empty
        	if(isSlotUsed(i))
        		tupleArr.add(tuples[i]);
        }
        return tupleArr.iterator();
    }
